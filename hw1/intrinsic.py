...
from extrinsic_estimation import compute_extrinsics
...
DATA_DIR = "/home/stream/Documents/NCTU_2021/Computer_Vision/ComputerVision_NCTU2021/data_D5100/"
DEBUG_DIR = "/home/stream/Documents/NCTU_2021/Computer_Vision/ComputerVision_NCTU2021/data_D5100/debug/"
...
for h_opt in H_r:
    try:
        ...
        # print(f'Intrinsic Camera Matrix after replace nan : {A}')

        E = compute_extrinsics(A, h_opt)
        E_all.append(E)
        print(f'Extrinsic Camera Matrix is : {H}')

    except Exception as e:
        print(e)

# extrinsics = np.array(E_all)
